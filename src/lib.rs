...
trait PieceRules {
    ...
    fn get_diagonal_squares(&self, piece_data: &PieceData) -> Vec<Square> { Vec::new() } // TODO: this should have default impl
    fn get_horizontal_squares(&self, piece_data: &PieceData) -> Vec<Square> { Vec::new() } // TODO: this should have default impl 
